...
public class ReplicationClinic extends Model {
	...
	public ReplicationClinic(Model owner, String name, boolean showInReport, boolean showInTrace) {
	...
	@Override
	public void init() {
		repTotalCost = new ConfidenceCalculator(this, "Per Replication: Total Cost", true, false); // gained from Tally
		repArrival = new ConfidenceCalculator(this, "Per Replication: Number of Patients arrived", true, false);
		...
		repNurseUtilization = new ConfidenceCalculator(this, "Per Replication: How much Nurses are used", true, false);
		repSpecialistUtilization = new ConfidenceCalculator(this, "Per Replication: How much specialists are used",
				true, false);
